        ...
        <div class="lrf-content">
          <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item prop="user">
              <div class="icon"></div>
              <el-input type="text" v-model="ruleForm2.user" placeholder="用户名" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item prop="pass">
              <div class="icon"></div>
              <el-input type="password" v-model="ruleForm2.pass" placeholder="新密码" auto-complete="off"></el-input>
            </el-form-item>
            <el-form-item>
              <el-button @click="resetForm('ruleForm2')">注册</el-button>
            </el-form-item>
          </el-form>
            <a class="back-login" href="javascript:history.go(-1)">返回上一步</a>
        </div>
      </div>
    </div>
  </div>
  ...
  export default{
    ...
    data () {
      ...
      var validatePass = (rule, value, callback) => {
        ...
        } else if (!validator.selfNumberReg) {
          callback(new Error('请输入8-16位的数字和字母组合密码'))
        } else {
      ...
      var checkUser = (rule, value, callback) => {
        ...
        setTimeout(() => {
          if (value.length < 2 && value.length > 8) {
            callback(new Error('请输如2-8位字符的用户名'))
          } else {
            callback()
          }
        }, 1000)
